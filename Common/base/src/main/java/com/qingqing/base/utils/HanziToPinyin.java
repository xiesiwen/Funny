...
public class HanziToPinyin {
    ...
    private static final HashMap<String,String> sFixedSortKeys = new HashMap<>();
    static {
        sFixedSortKeys.put("厦门","xiamen");
        sFixedSortKeys.put("重庆","chongqing");
    }
    /**
     * Unihans array.
     * <p/>
    ...
    private static Map<String,Character> specialHanzi = new HashMap<String,Character>();
...
//            sInstance = new HanziToPinyin(false);
    ...
    public static String getSortKey(String input) {
        ...
        return fixSortKey(input, sb.toString());
    }

    private static String fixSortKey(String input, String sortKey){
        if(sFixedSortKeys.containsKey(input)){
            return sFixedSortKeys.get(input);
        }
        return sortKey;
    }
}
