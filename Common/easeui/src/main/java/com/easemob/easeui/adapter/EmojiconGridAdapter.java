...
public class EmojiconGridAdapter extends ArrayAdapter<EaseEmojicon>{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(convertView == null){
            ...
            }else if (emojiconType == Type.EMOJI){
                convertView = View.inflate(getContext(), R.layout.ease_row_emoji, null);
            }else{
        ...
        TextView emojiText = (TextView)convertView.findViewById(R.id.tv_emoji);
        if (emojiText!=null){
        ...
        if (emojiText!=null && !EaseSmileUtils.DELETE_KEY.equals(emojicon.getEmojiText())){
            emojiText.setText(emojicon.getEmojiText());
