    ...
    protected void onInflatView() {
        inflater.inflate(
                message.direct == EMMessage.Direct.RECEIVE && !extField.isSelfMock
                        ? R.layout.ease_row_received_location
...
//        intent.putExtra("latitude", locBody.latitude);
//        intent.putExtra("longitude", locBody.longitude);
//        intent.putExtra("address", locBody.address);
