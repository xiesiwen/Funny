...
import com.easemob.easeui.model.EaseDefaultEmojiDatas;
...
public class EaseChatInputMenu extends LinearLayout {
    ...
    public void init(List<EaseEmojiconGroupEntity> emojiconGroupList) {
        ...
        if(chatPrimaryMenu == null){
            ...
            if (chatPrimaryMenu instanceof EaseChatPrimaryMenu){
                ((EaseChatPrimaryMenu) chatPrimaryMenu).setShowFace(showFace);
            }
        }
        ...
        if(emojiconMenu == null){
            ...
            if(emojiconGroupList == null){
                ...
                EaseEmojiconGroupEntity entity = new EaseEmojiconGroupEntity(0, Arrays.asList(EaseDefaultEmojiDatas.getData()), EaseEmojicon.Type.EMOJI);
                entity.setName(new String(Character.toChars(0x1F60a)));
                emojiconGroupList.add(entity);
            }
    ...
    public void registerExtendMenuItem(String name, int drawableRes, int itemId,boolean remain,
                                       EaseChatExtendMenuItemClickListener listener) {
        chatExtendMenu.registerMenuItem(name, drawableRes, itemId, remain, listener);
    }
    ...
    public void registerExtendMenuItem(int nameRes, int drawableRes, int itemId, boolean remain,
                                       EaseChatExtendMenuItemClickListener listener) {
        chatExtendMenu.registerMenuItem(nameRes, drawableRes, itemId, remain, listener);
    }

    public void hideExtendMenuItemRemain(int itemId) {
        chatExtendMenu.hideMenuItemRemain(itemId);
    }
    ...
    public void setShowFace(boolean showFace) {
        ...
        if (chatPrimaryMenu!=null && chatPrimaryMenu instanceof EaseChatPrimaryMenu){
            ((EaseChatPrimaryMenu) chatPrimaryMenu).setShowFace(showFace);
        }
    }
    ...
    public void setGroupId(String groupId) {
        ...
        chatPrimaryMenu.setGroupId(groupId);
    }
