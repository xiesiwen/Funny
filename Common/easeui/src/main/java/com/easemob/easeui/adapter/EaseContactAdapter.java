...
public class EaseContactAdapter extends ArrayAdapter<ContactInfo> implements SectionIndexer{
    ...
    public EaseContactAdapter(Context context, int resource, List<ContactInfo> objects) {
        super(context, resource, objects);
        this.res = resource;
        this.userList = objects;
        copyUserList = new ArrayList<ContactInfo>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ContactInfo user = getItem(position);
        if(user == null)
    ...
    protected class  MyFilter extends Filter{
        List<ContactInfo> mOriginalList = null;
        
        public MyFilter(List<ContactInfo> myList) {
        ...
        protected synchronized FilterResults performFiltering(CharSequence prefix) {
            ...
            if(mOriginalList==null){
                mOriginalList = new ArrayList<ContactInfo>();
            }
            ...
            if(prefix==null || prefix.length()==0){
                ...
                final ArrayList<ContactInfo> newValues = new ArrayList<ContactInfo>();
                for(int i=0;i<count;i++){
                    final ContactInfo user = mOriginalList.get(i);
        ...
        protected synchronized void publishResults(CharSequence constraint,
            ...
            userList.clear();
            userList.addAll((List<ContactInfo>)results.values);
