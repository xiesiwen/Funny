...
public class EaseContactListFragment extends EaseBaseFragment {
    ...
    protected List<ContactInfo> contactList;
    protected ListView listView;
    protected boolean hidden;
    protected List<String> blackList;
    protected ImageButton clearSearch;
    protected LimitEditText query;
    protected Handler handler = new Handler();
    protected ContactInfo toBeProcessUser;
    protected String toBeProcessUsername;
    protected EaseContactList contactListLayout;
    protected boolean isConflict;
    protected FrameLayout contentContainer;
    
    private Map<String, ContactInfo> contactsMap;
    ...
    protected void initView() {
        ...
        //搜索框
        query = (LimitEditText) getView().findViewById(R.id.query);
        ...
        if(listItemClickListener != null){
            listView.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ContactInfo user = (ContactInfo)listView.getItemAtPosition(position);
...
//                    itemClickLaunchIntent.putExtra(EaseConstant.USER_ID, username);
        ...
        query.addTextChangedListener(new LimitedTextWatcher() {
    ...
    protected void getContactList() {
        ...
        synchronized (contactList) {
            ...
            Iterator<Entry<String, ContactInfo>> iterator = contactsMap.entrySet().iterator();
            while (iterator.hasNext()) {
                ...
                if (!entry.getKey().equals("item_new_friends")
                    ...
                    if(!blackList.contains(entry.getKey())){
                        //不显示黑名单中的用户
                        ContactInfo user = entry.getValue();
     ...
     * @param contactsMap
     */
    public void setContactsMap(Map<String, ContactInfo> contactsMap){
    ...
    public interface EaseContactListItemClickListener {
         ...
         */
        void onListItemClicked(ContactInfo user);
    }
