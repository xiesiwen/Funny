    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (conversation.getType() == EMConversationType.GroupChat) {
            ...
            holder.name.setText(group != null ? group.getGroupName()
                    : ChatManager.getInstance().getGroupNameFromConversation(
        ...
        protected FilterResults performFiltering(CharSequence prefix) {
            ...
            if (prefix == null || prefix.length() == 0) {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    EMGroup group = EMGroupManager.getInstance().getGroup(username);
                    String groupName = ChatManager.getInstance()
                            .getGroupNameFromConversation(EMChatManager.getInstance()
                                    .getConversation(username));
                    if (group != null || !TextUtils.isEmpty(groupName)) {
                        username = group != null ? group.getGroupName() : groupName;
                    }else{
